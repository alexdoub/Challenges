...
class BinaryTreeMaxSimplePathTest {
    @Test
    fun test1() {
        //  1
        // 2, 3
        val tree: Array<Int?> = arrayOf(1, 2, 3)
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(6, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
    ...
    fun test2() {
        ...
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(42, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
    ...
    fun test3_homemade() {
        ...
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(100, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
    ...
    fun test4_homemade() {
        ...
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(10, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
    ...
    fun test6_homemade() {
        ...
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(11, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
    ...
    fun test7_homemade() {
        ...
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(1, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
    ...
    fun test8() {
        ...
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(48, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
    ...
    fun test9() {
        ...
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(4, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
    ...
    fun test9_SIMPLIFIED() {
        ...
        val head = BinaryTreeMaxSimplePath.buildTree(tree)
        assertEquals(15, BinaryTreeMaxSimplePath.maxPathSum(head))
    }
}