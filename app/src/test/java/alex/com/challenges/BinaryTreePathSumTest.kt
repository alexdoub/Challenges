...
class BinaryTreePathSumTest {
    ...
    fun test_empty() {
        ...
        assertEquals(false, BinaryTreePathSum.hasPathSum(tree, 0))
    }

    @Test
    fun test_single() {
        val tree = buildTree(arrayOf(5))
        assertEquals(true, BinaryTreePathSum.hasPathSum(tree, 5))
    }
    ...
    fun unbalanced_2_layers_1() {
        ...
        val target = 1
        assertEquals(false, BinaryTreePathSum.hasPathSum(tree, target))
    }
    ...
    fun unbalanced_2_layers_2() {
        val tree = buildTree(arrayOf(1,2))
        val target = 3
        assertEquals(true, BinaryTreePathSum.hasPathSum(tree, target))
    }
