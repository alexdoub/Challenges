...
class MapTest {
    ...
    fun testMyStuff() {
        ...
        val blockedLocations = ArrayList<Pair<Int, Int>>().apply{ add(startPosition)}
        val minMoves = getMinimumMoves(startPosition, goalPosition, blockedLocations)
        println("minMoves= $minMoves")
    }
